            ...
            <div class="modal-body">
                <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input value="{{old('serialequipo')}}" type="text" class="form-control @error('serialequipo') is-invalid @enderror solo_numeros"  name="serialequipo" id="serialequipo" onkeypress="return soloNumeros(event)">
                            @error('serialequipo')
                ...
                <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input value="{{old('observacion')}}" type="text" class="form-control @error('observacion') is-invalid @enderror solo_letras"  name="observacion" id="observacion" onkeypress="return soloLetras(event)">
                            @error('observacion')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
