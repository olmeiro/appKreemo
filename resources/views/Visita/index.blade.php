...
<!-- <div class="modal fade" id="agenda_modal1" tabindex="-1" role="dialog" data-backdrop="static">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
      ...
      <div class="modal-footer">
        ...
        <button onclick="guardar()" type="button" class="btn btn-success">Editar</button>
        <button onclick="guardar()" type="button" class="btn btn-success">Eliminar</button>
      </div>
    </div>
  </div> -->
@endsection
