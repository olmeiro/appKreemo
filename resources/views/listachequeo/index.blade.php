...
@section('body')
    <div class="card">
        <div class="card-header">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#crear">Crear Lista de Chequeo </button>
        ...
        <!-- <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Editar Lista de Chequeo</h5> <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
                    </div>
                    <div class="modal-body">
                        @include('flash::message')
                        <form action="/listachequeo/actualizar" method="POST" id="editform" enctype="multipart/form-data">
                        @csrf
                                <div id="smartwizard2">
                                    <ul>
                                        <li><a href="#step-1">Paso 1<br /><small>INFORMACIÓN GENERAL</small></a></li>
