            ...
            <input type="hidden" name="id" id="id" value="{{$operario->id}}">
                <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input value="{{$operario->nombre}}" type="text" class="form-control @error('nombre') is-invalid @enderror solo_letras"  name="nombre" id="nombre">
                            @error('nombre')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input value="{{$operario->apellido}}" type="text" class="form-control @error('apellido') is-invalid @enderror solo_letras"  name="apellido" id="apellido">
                            @error('apellido')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
