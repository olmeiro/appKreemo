...
class User extends Authenticatable
{
    ...
    public static $permisos = [
        1=>[
            ...
            ["url" => "/servicio/cambiar/estado", "method"=>"GET", "identica"=>false], //para cambiar el estado de la visita
            ...
            ["url" => "/cotizacion/guardar", "method"=>"POST", "identica"=>true],
            ["url" => "/cotizacion/editar/{id}", "method"=>"GET", "identica"=>false],
            ["url" => "/cotizacion/actualizar", "method"=>"POST", "identica"=>true],
            ["url" => "/cotizacion/editarEstado/{id}", "method"=>"GET", "identica"=>false],
            ["url" => "/cotizacion/estado", "method"=>"POST", "identica"=>true],

            ["url" => "/ajaxestado", "method"=>"POST", "identica"=>true],
            ["url" => "/estadocotizacion", "method"=>"GET", "identica"=>true],
            ["url" => "/estadocotizacion/listar", "method"=>"GET", "identica"=>true],
            ["url" => "/estadocotizacion/crear", "method"=>"GET", "identica"=>true],
            ["url" => "/estadocotizacion/guardar", "method"=>"POST", "identica"=>true],
            ["url" => "/estadocotizacion/editar/{id}", "method"=>"GET", "identica"=>false],
            ["url" => "/estadocotizacion/actualizar", "method"=>"POST", "identica"=>true],
            ["url" => "/estadocotizacion/eliminar/{id}", "method"=>"GET", "identica"=>false],
            ...
            ["url" => "/encuesta/eliminar/{id}", "method"=>"GET", "identica"=>false],
