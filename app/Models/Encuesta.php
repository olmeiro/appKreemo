...
class Encuesta extends Model
{
    ...
    public static $rules = [
        ...
        'mes' => 'required|date',
        'respuesta1_1' => 'required|integer|max:5',
        'respuesta1_2' => 'required|integer|max:5',
        'respuesta1_3' => 'required|integer|max:5',
        'respuesta1_4' => 'required|integer|max:5',
        'respuesta2' => 'required|string|max:2',
        'respuesta3' => 'max:300',
